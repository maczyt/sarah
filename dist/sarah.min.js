...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var _watchArray=require("./watchArray"),_watchArray2=_interopRequireDefault(_watchArray),_sarah=require("./sarah"),_sarah2=_interopRequireDefault(_sarah);function _interopRequireDefault(a){return a&&a.__esModule?a:{default:a}}var mutationHandlers={push:function push(a){var b=this;a.args.forEach(function(a,c){var d=b.buildItem(a,b.collection.length+c);b.container.insertBefore(d.el,b.marker)})}};exports.default={text:function text(a){this.el.textContent=a||""},class:function _class(a){this.el.classList[a?"add":"remove"](this.arg)},show:function show(a){this.el.style.display=a?"":"none"},repeat:{bind:function bind(){this.el["s-block"]=!0,this.prefixRE=new RegExp("^"+this.arg+".");var a=this.container=this.el.parentNode;this.marker=document.createComment("s-repeat-"+this.arg+"-marker"),a.insertBefore(this.marker,this.el),a.removeChild(this.el),this.childSarahs=[]},update:function update(a){var b=this;this.collection=a,(0,_watchArray2.default)(a,this.mutate.bind(this)),a.forEach(function(a,c){b.childSarahs.push(b.buildItem(a,c))})},mutate:function mutate(a){mutationHandlers[a.event].call(this,a)},buildItem:function buildItem(a,b){var c=this.el.cloneNode(!0),d=new _sarah2.default({el:c,scope:a,eachPrefixRE:this.prefixRE,parentScope:this.vm.scope});return this.container.insertBefore(c,this.marker),this.collection[b]=d.scope,d}},on:{update:function update(a){var b=this.arg,c=this.handlers=this.handlers||{};c[b]&&this.el.removeEventListener(b,c[b]),a&&(a=a.bind(this.vm),this.el.addEventListener(b,a),c[b]=a)},unbind:function unbind(){var a=this.arg;this.handlers&&this.el.removeEventListener(a,this.handlers[a])}}};
